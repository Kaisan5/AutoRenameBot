...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      ...
      InlineKeyboardButton('Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/Animestation_Chat_Group'),
      InlineKeyboardButton('Sᴜᴩᴩᴏʀᴛ', url='https://t.me/AnimeStation2')
    ],[
...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton('Bᴜʏ Nᴏᴡ ⚡', url='https://t.me/ItzMonkeyDLuffy')
                ],[
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton('Sᴇǫᴜᴇɴᴄᴇ', url='https://t.me/Animestation_Chat_Group')
                ],[
                InlineKeyboardButton('Pʀᴇᴍɪᴜᴍ', callback_data='premium'),
